...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\Development\\Projects\\Node\\NextJs\\Project\\nest-task_manager\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "D:\\Development\\Projects\\Node\\NextJs\\Project\\nest-task_manager\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres:password123@localhost:5432/Task_manager?schema=public"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Task {\n  id          String     @id @default(cuid())\n  title       String\n  description String\n  status      TaskStatus @default(IN_PROGRESS)\n  createdAt   DateTime   @default(now())\n  updatedAt   DateTime   @updatedAt\n  User        User?      @relation(fields: [userId], references: [id])\n  userId      String?\n}\n\nmodel User {\n  id             String   @id @default(cuid())\n  name           String\n  email          String   @unique\n  password       String\n  role           UserRole @default(USER)\n  profilePicture String?\n  tasks          Task[]\n  createdAt      DateTime @default(now())\n  updatedAt      DateTime @updatedAt\n}\n\nenum UserRole {\n  ADMIN\n  USER\n  MODERATOR\n}\n\nenum TaskStatus {\n  IN_PROGRESS\n  COMPLETED\n  CANCELLED\n}\n",
  "inlineSchemaHash": "80c4216b4d94e3624c91b95120071d414e24d88a7305a9e5c9c06a024db6a070",
  "copyEngine": true
}
